package com.dyg.siginprint.kaigong;
...
public class KaigongActivity extends BaseActivity<PurchasePresenter> implements IPurchaseView, ClearEditText.Listener {
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if (loginBean == null) finish();
            ...
            mActivity = KaigongActivity.this;
    ...
    private void initHR(){
        ...
        //3.4 获取控件设定的最大宽度
        setMaxWidth = getSetMaxWidthList(KaigongActivity.this, R.layout.item_hrecycleview, mMoveViewListID);
