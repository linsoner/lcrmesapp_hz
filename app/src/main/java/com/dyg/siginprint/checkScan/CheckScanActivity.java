...
public class CheckScanActivity extends BaseActivity<PurchasePresenter> implements IPurchaseView, ClearEditText.Listener {
    ...
    protected void initPresenter() {
        presenter = new PurchasePresenter(CheckScanActivity.this,this);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if (loginBean == null) finish();
            ...
            mActivity = CheckScanActivity.this;
    ...
    private void initHR(){
        ...
        //3.4 获取控件设定的最大宽度
        setMaxWidth = getSetMaxWidthList(CheckScanActivity.this, R.layout.item_hrecycleview, mMoveViewListID);
