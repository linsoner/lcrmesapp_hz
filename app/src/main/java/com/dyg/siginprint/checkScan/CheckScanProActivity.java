package com.dyg.siginprint.checkScan;
...
public class CheckScanProActivity extends BaseActivity<PurchasePresenter> implements IPurchaseView, ClearEditText.Listener {
    ...
    protected void initPresenter() {
        presenter = new PurchasePresenter(CheckScanProActivity.this,this);
    ...
    protected void initViews(Bundle savedInstanceState) {
        ...
        if (loginBean == null) finish();
            ...
            mActivity = CheckScanProActivity.this;
    ...
    private void initHR(){
        ...
        //3.4 获取控件设定的最大宽度
        setMaxWidth = getSetMaxWidthList(CheckScanProActivity.this, R.layout.item_hrecycleview, mMoveViewListID);
    ...
    private void clearView(boolean clearDefuatCache){
        ...
        if(clearDefuatCache){
            ...
            Hawk.delete(userCode + HawkKeys.HAWK_CheckScan_BillTypeName);
        }
...
//                //来源单类型
            ...
            case R.id.tv_temporary_storage:{
                ...
                Hawk.put(userCode + HawkKeys.HAWK_CheckScan_temBean , bean);
