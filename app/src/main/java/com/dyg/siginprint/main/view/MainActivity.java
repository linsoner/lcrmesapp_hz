...
public class MainActivity extends BaseActivity<MainPresenter> implements IMainView {
    ...
    List<FunItemBean> funList = Arrays.asList(
            new FunItemBean("材料采购进退货",R.mipmap.caigoujinhuo,"1"),
            new FunItemBean("材料拆标签",R.mipmap.chaifen,"10"),
            new FunItemBean("材料扫码核对",R.mipmap.heduisaoma,"2"),
            ...
            //new FunItemBean("成品采购进退货",R.mipmap.caigoujinhuored,"11"),
            //new FunItemBean("成品扫码核对",R.mipmap.heduisaomared,"8"),
            ...
            new FunItemBean("生产扫码核对",R.mipmap.heduisaoma,"9"),
